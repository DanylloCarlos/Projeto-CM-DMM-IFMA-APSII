 ...
 */
class DelOuAtRelatorio extends TPage
{
    private $datagrid;
    ...
    public function __construct()
    {
        ...
        $nome       = new TDataGridColumn('nome',    'Nome',    'right',  '10%'); //code Code
        $freq       = new TDataGridColumn('freq',    'Frequência',    'left',   '30%'); //name Name
        $dtIni    = new TDataGridColumn('inicio', 'Inicio', 'left',   '30%'); //address Address
        $dtFim  = new TDataGridColumn('fim',    'Fim',   'left',   '30%'); //fone Phone
        
        $dtFim->setDataProperty('hiddable', 400);
